...
export function calculateCreditworthiness(data, options = {}) {
    ...
    const averageDailyBalanceCapitalScore = averageDailyBalance >= 10000 ? 40 : averageDailyBalance >= 5000 ? 25 : averageDailyBalance >= 1000 ? 15 : 0;
      ...
      it('should handle zero-income scenario', () => {
        ...
        expect(result.disclosures).toEqual(
          expect.arrayContaining([
            'ZERO_INCOME_WARNING: Zero income detected; consider alternative income sources or a secured card.'
          ])
        );
      });
    });
