...
// Add these after the React import and before any usage
const LenderDashboard = React.lazy(() => import('./components/LenderDashboard'));
const PremiumDashboard = React.lazy(() => import('./components/PremiumDashboard'));
  ...
  return (
    <ErrorBoundary>
      <div className={`min-h-screen flex flex-col ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
            ...
            <Routes>
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute user={user} requiredRole={['premium', 'admin']}>
                      <Suspense fallback={<div className="h-screen flex items-center justify-center text-gray-400">Loading premium dashboard...</div>}>
                        <PremiumDashboard />
                      </Suspense>
                    </ProtectedRoute>
                  } 
              ...
              <Route element={<ProtectedRoute user={user} requiredRole="admin" />}>
                <Route path="/admin/*" element={
                  <Suspense fallback={<div className="h-screen flex items-center justify-center text-gray-400">Loading admin dashboard...</div>}>
              ...
              <Route 
                ...
                element={
                  <ProtectedRoute user={user} requiredRole={['lender', 'admin']}>
                    <Suspense fallback={<div className="h-screen flex items-center justify-center text-gray-400">Loading lender dashboard...</div>}>
                      <LenderDashboard />
                    </Suspense>
                  </ProtectedRoute>
                } 
        ...
        {auth && (
          <footer className="bg-white dark:bg-[#18191a] border-t border-gray-200 dark:border-gray-700 py-4">
      ...
      {/* Ensure full matte black background in dark mode */}
      <style>{`
        html.dark body, html.dark #root, html.dark .App {
